...
let propertyFormImage = "https://d2s80gmgq3vhu4.cloudfront.net/HomeSlideImages/assets/Images/propertyFormImage.png";


const PropertyContactFormInterior = () => {
  const buttonStyle = {
    border: "unset",
      ...
      {first && (
        ...
        <div className="pcfp-r-cotnainer">
          ...
          <h2 className="large-heading pcfp-head">
            What type of Interior Space are you looking for?
          </h2>
...
export default PropertyContactFormInterior;
