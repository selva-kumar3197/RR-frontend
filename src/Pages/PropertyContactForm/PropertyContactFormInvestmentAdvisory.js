...
const PropertyContactFormInvestmentAdvisory = () => {
  const buttonStyle = {
    border: "unset",
      ...
      {first && (
        ...
        <div className="pcfp-r-cotnainer">
          ...
          <h2 className="large-heading pcfp-head">
            What type of Investment Advisory Space are you looking for?
          </h2>
...
export default PropertyContactFormInvestmentAdvisory;
